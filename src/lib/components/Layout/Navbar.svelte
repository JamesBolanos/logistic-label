        ...
        <div class="flex">
          ...
          <div class="hidden sm:ml-6 sm:flex sm:space-x-8">
            ...
            {#if isLoggedIn}
              ...
              <a 
                href="/settings" 
                class="{page.url.pathname === '/settings' ? 'border-blue-500 text-gray-900' : 'border-transparent text-gray-500 hover:border-gray-300 hover:text-gray-700'} inline-flex items-center px-1 pt-1 border-b-2 text-sm font-medium"
              >
                Settings
              </a>
            {/if}
      ...
      <div class="sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
          ...
          {#if isLoggedIn}
            ...
            <a
              href="/settings"
              class="{page.url.pathname === '/settings' ? 'bg-blue-50 border-blue-500 text-blue-700' : 'border-transparent text-gray-500 hover:bg-gray-50 hover:border-gray-300 hover:text-gray-700'} block pl-3 pr-4 py-2 border-l-4 text-base font-medium"
            >
              Settings
            </a>
          {/if}
        ...
        <div class="pt-4 pb-3 border-t border-gray-200">
          {#if isLoggedIn}
            <div class="flex items-center px-4">
              <div class="ml-3">
                <div class="text-base font-medium text-gray-800">{user?.displayName || 'User'}</div>
